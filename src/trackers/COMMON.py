...
class COMMON:
    ...
    unit3d_region_map = {
        ...
        'ZIM': 242, 'EUR': 243, 'CZE': 244
    }

    unit3d_additional_regions = {}

    unit3d_distributor_map = {
    ...
    unit3d_additional_distributors = {}
    ...
    async def unit3d_region_ids(self, region: str = "", reverse: bool = False, region_id: int = 0) -> str:
        region_map = {**self.unit3d_region_map, **self.unit3d_additional_regions}
    ...
    async def unit3d_distributor_ids(self, distributor: str = "", reverse: bool = False, distributor_id: int = 0) -> str:
        distributor_map = {**self.unit3d_distributor_map, **self.unit3d_additional_distributors}
